...
This repository is the final project for ECON211.The project applies the Alpaca-LoRA method to fine-tune large language models to analyze impact of news on gold prices
## Project information
